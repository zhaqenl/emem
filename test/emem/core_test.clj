...
(def text-expect-1b
  "<!DOCTYPE html>\n<html><head><title># foo **bar** baz</title><meta charset=\"utf-8\" /><meta content=\"max-age=86400\" http-equiv=\"Cache-control\" /><meta content=\"width=device-width,initial-scale=1.0,user-scalable=yes\" name=\"viewport\" /><meta content=\"noodp,noydir\" name=\"robots\" /></head><body><div id=\"content\"><h1>foo <strong>bar</strong> baz</h1></div><script src=\"static/js/highlight.pack.js\"></script><script>hljs.initHighlightingOnLoad();</script></body></html>")

(def text-expect-2b
  "<!DOCTYPE html>\n<html><head><title>Some Title</title><meta charset=\"utf-8\" /><meta content=\"max-age=86400\" http-equiv=\"Cache-control\" /><meta content=\"width=device-width,initial-scale=1.0,user-scalable=yes\" name=\"viewport\" /><meta content=\"noodp,noydir\" name=\"robots\" /></head><body><div id=\"content\"><h1>Some Title</h1><h2>Section 1</h2><p>Lorem ipsum dolor sit <em>amet</em>, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. <strong>Nullam</strong> malesuada erat ut turpis. <i>Suspendisse</i> urna nibh, viverra non, semper suscipit, posuere a, pede.</p><pre><code>$ foo bar baz\n# qux quux</code></pre><h2>Section 2</h2><blockquote><p> Donec nec justo eget felis facilisis fermentum. Aliquam porttitor  mauris sit amet orci. Aenean dignissim pellentesque felis. </p></blockquote><pre><code>blah blah blah\n</code></pre></div><script src=\"static/js/highlight.pack.js\"></script><script>hljs.initHighlightingOnLoad();</script></body></html>")
