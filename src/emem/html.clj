        ...
        (when (not (:plain opts))
          (if (:standalone opts)
            ...
            (hi/html
             ...
             ;; ewan.css and highlight.pack.js
             (when-not (= (:style opts) "-")
               (hi/html
